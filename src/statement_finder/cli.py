...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--year", type=str, default="", help="Year folder, for example 2024. Empty means all")
    p.add_argument("--month", type=str, default="", help="Month folder name, for example 03-March. Empty means all")
    p.add_argument("--clients", type=str, default="", help="Comma separated client names")
    p.add_argument("--types", type=str, default="", help="Comma separated statement types, for example K-1,CC,STMT")
...
def main() -> None:
    ...
    base_dir = args.base_dir or Path(cfg.get("base_directory", "YOUR_FILE_PATH_HERE/Client Statements"))
    output_dir = args.output_dir or Path(cfg.get("output_directory", "YOUR_FILE_PATH_HERE/statement_finder_output"))
